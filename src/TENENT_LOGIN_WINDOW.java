 ...
 * @author AVS Vastalya
 */
public class TENENT_LOGIN_WINDOW extends javax.swing.JFrame {

    /**
     * Creates new form TENENT_LOGIN_WINDOW
     */
    public TENENT_LOGIN_WINDOW() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel_title.setFont(new java.awt.Font("Arial", 1, 55)); // NOI18N
        jLabel_title.setForeground(new java.awt.Color(108, 3, 69));
        jLabel_title.setText("TENENT LOGIN");

        jLabel_password_icon.setBackground(new java.awt.Color(102, 102, 255));
        jLabel_password_icon.setOpaque(true);

        jLabel_username_icon.setBackground(new java.awt.Color(102, 102, 255));
        ...
        jButton_login.setBackground(new java.awt.Color(108, 3, 69));
        ...
        jButton_back.setBackground(new java.awt.Color(255, 153, 0));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(jButton_back, javax.swing.GroupLayout.PREFERRED_SIZE, 107, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(84, 84, 84))
        );
    ...
    private void jButton_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_loginActionPerformed
        ...
        String selectquery = "SELECT * FROM tenent_login WHERE username = ? AND password = ?";
        ...
        else
        {
            try
            {
                ...
                if(rs.next())
                {
                    ...
                    //show the main form
                    TENENT_MAIN_WINDOW mainform = new TENENT_MAIN_WINDOW();
    ...
    private void jButton_backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_backActionPerformed
        ...
        INITIAL_WINDOW initialform = new INITIAL_WINDOW();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TENENT_LOGIN_WINDOW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TENENT_LOGIN_WINDOW().setVisible(true);
            }
        });
    }
