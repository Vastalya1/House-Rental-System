 ...
 * @author AVS Vastalya
 */
public class SHOW_SEARCHED_PROPERTIES_WINDOW extends javax.swing.JFrame {
        private ArrayList<P_PROPERTY> propertyList;
    /**
     * Creates new form SHOW_SEARCHED_PROPERTIES_WINDOW
     */
       // P_TYPE type = new P_TYPE();
    public SHOW_SEARCHED_PROPERTIES_WINDOW(ArrayList<P_PROPERTY> propertyList) {
    ...
    public void fillJtableWithPropertiesData() {
        ...
        for (int i = 0; i < propertyList.size(); i++) {
            ...
            rows[i][9] = propertyList.get(i).isBalcony() ? "YES" : "NO";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SHOW_SEARCHED_PROPERTIES_WINDOW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                // Create an ArrayList to hold property data
            ArrayList<P_PROPERTY> propertyList = new ArrayList<>();
            // Add property data to the list
            
            // Create an instance of SHOW_SEARCHED_PROPERTIES_WINDOW with the property list
            new SHOW_SEARCHED_PROPERTIES_WINDOW(propertyList).setVisible(true);
