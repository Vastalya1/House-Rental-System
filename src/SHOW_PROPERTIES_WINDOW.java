...
public class SHOW_PROPERTIES_WINDOW extends javax.swing.JFrame {
    ...
    public void fillJtableWithPropertiesData()
    {
        ...
        //the jtable columns
        String[] colNames = {"ID","Type","Square_Feet","OwnerId","Price","Address", "Bedrooms", "Bathrooms", "Age", "Balcony", "description", "Status"};
        
        //the jtable row
        //properityList.size()= the size of the arrayList
        Object[][] rows = new Object[propertyList.size()][12];
        ...
        for(int i=0; i< propertyList.size(); i++)
        {
            ...
            //rows[i][11]= propertyList.get(i).getStatus();
        }
