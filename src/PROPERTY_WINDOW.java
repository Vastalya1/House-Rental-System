...
public class PROPERTY_WINDOW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel_title.setBackground(new java.awt.Color(108, 3, 69));
        ...
        jButton_search_property.setBackground(new java.awt.Color(150, 50, 200));
        ...
        jCheckBox_balcony.setBackground(new java.awt.Color(255, 248, 220));
        ...
        jButton_show_property.setBackground(new java.awt.Color(252, 172, 51));
    ...
    private void jButton_edit_propertyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_edit_propertyActionPerformed
        ...
        try{
            ...
            P_PROPERTY property = new P_PROPERTY(id,type,squareFeet,ownerId,price,address,bedrooms,bathrooms,age,description,haveBalcony,saleStatus);
    ...
    private void jButton_add_propertyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_add_propertyActionPerformed
        ...
        try{
            ...
            P_PROPERTY property = new P_PROPERTY(0,type,squareFeet,ownerId,price,address,bedrooms,bathrooms,age,description,haveBalcony,saleStatus);
